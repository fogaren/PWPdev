...
gravity=9.807; % accleration due to gravity in m/s^2
...
alpha=gsw_alpha(S(1),T(1),0);
beta=gsw_beta(S(1),T(1),0);
...
if hbl>hbl_max
    ...
    KM0=KM;
    KH0=KH;
    x = input(['maximum hbl exceeded. hbl = ' num2str(hbl)]);
end
...
% Constants for shap functions as per LMD (17)
